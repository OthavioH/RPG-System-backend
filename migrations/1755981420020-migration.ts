...
export class migration1755981420020 implements MigrationInterface {
    name = 'migration1755981420020'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "gamesettings" DROP COLUMN "lastRolls"`);
        await queryRunner.query(`ALTER TABLE "gamesettings" DROP COLUMN "skills"`);
        await queryRunner.query(`ALTER TABLE "gamesettings" DROP COLUMN "abilities"`);
        await queryRunner.query(`ALTER TABLE "gamesettings" DROP COLUMN "rituals"`);
        ...
        await queryRunner.query(`ALTER TABLE "gamesettings" DROP CONSTRAINT "PK_960a172f77b86d559d8035aeb2a"`);
        await queryRunner.query(`ALTER TABLE "gamesettings" DROP COLUMN "id"`);
        await queryRunner.query(`ALTER TABLE "gamesettings" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`);
        await queryRunner.query(`ALTER TABLE "gamesettings" ADD CONSTRAINT "PK_960a172f77b86d559d8035aeb2a" PRIMARY KEY ("id")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "gamesettings" DROP CONSTRAINT "PK_960a172f77b86d559d8035aeb2a"`);
        await queryRunner.query(`ALTER TABLE "gamesettings" DROP COLUMN "id"`);
        await queryRunner.query(`ALTER TABLE "gamesettings" ADD "id" SERIAL NOT NULL`);
        await queryRunner.query(`ALTER TABLE "gamesettings" ADD CONSTRAINT "PK_960a172f77b86d559d8035aeb2a" PRIMARY KEY ("id")`);
        ...
        await queryRunner.query(`ALTER TABLE "gamesettings" ADD "rituals" text`);
        await queryRunner.query(`ALTER TABLE "gamesettings" ADD "abilities" text`);
        await queryRunner.query(`ALTER TABLE "gamesettings" ADD "skills" text`);
        await queryRunner.query(`ALTER TABLE "gamesettings" ADD "lastRolls" text`);
